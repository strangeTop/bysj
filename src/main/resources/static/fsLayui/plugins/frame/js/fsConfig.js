...
layui.define([], function (exports) {
	...
	fsConfig["global"] = {
		...
		"loginUrl" : "/toLogin", //登录url
		"uploadUrl" : "/upload", //上传附件url
		"uploadHtmlUrl" : "/fsLayui/plugins/frame/views/upload.html", //上传附件html地址，默认/plugins/frame/views/upload.html
		...
		"page" : { //分页配置
			"sortType":"1",//默认排序方式，0：本地排序，1：异步排序，不配置默认为0
			"request": {//请求配置
